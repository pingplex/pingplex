...
// Module creates and returns an FX module for the users package.
//
// This function defines how the users module should be wired into an application
...
//   - Repository for data access (provided privately)
//   - Service for business logic (provided publicly)
//
// FX will automatically resolve dependencies and inject them where needed.
// For example, the Service depends on Config, Repository, Metrics, Logger, and Cache,
...
//	fx.Invoke(func(service *users.Service) {
//	    // Use the service
//	})
